 ...
 */
package com.zq.administrator.mdapplication.utils;
...
/**
 * The utils of App system
 *
 * @author Harrison (https://github.com/kymjs)
 * @version 1.1
 */
public final class SystemTool {
     ...
     * Install apk
     * @param context
     * @param file The file of the apk need to be installed.
     */
    ...
    public static String getSign(Context context, String pkgName) {
        try {
            @SuppressLint("PackageManagerGetSignatures") PackageInfo pis = context.getPackageManager().getPackageInfo(

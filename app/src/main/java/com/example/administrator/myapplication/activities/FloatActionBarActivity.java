...
import com.zq.administrator.mdapplication.fragment.TabListFragment;
...
public class FloatActionBarActivity extends com.zq.administrator.mdapplication.BaseActivity {
    ...
    public static void startActivity(Context context ){
        Intent intent = new Intent(context, FloatActionBarActivity.class);
